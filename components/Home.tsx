  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-background">
      <motion.svg
        ...
        role="img"
        viewBox="0 0 512 512"
        className="hidden lg:block w-12 h-12 absolute top-1/4 left-1/4 -rotate-12 drop-shadow-[0_16px_24px_rgba(49,120,198,0.35)] z-10"
        style={{
      ...
      <motion.svg
        className="hidden lg:block w-12 h-12 absolute top-3/4 left-1/4 drop-shadow-[0_16px_24px_rgba(0,0,255,0.35)] z-10"
        style={{
      ...
      <motion.svg
        ...
        initial="initial"
        animate="animate"
        className="hidden lg:block w-16 h-16 absolute bottom-1/4 right-48 rotate-12 drop-shadow-[0_16px_24px_rgba(160,79,18,0.35)] z-10"
        fill="none"
        viewBox="0, 0, 32, 32"
        xmlns="http://www.w3.org/2000/svg"
      >
